    ...
    <View style={styles.container}>
      ...
      <View style={styles.instructionBox}>
        ...
        <Text style={styles.instructionText}>
          {instruction ||
            (mode === 'enroll'
              ? 'Fit your face inside the oval. Ensure even lighting and look straight at the camera.'
              : 'Fit your face in the oval. Ensure good lighting and look straight at the camera.')}
        </Text>
      </View>
